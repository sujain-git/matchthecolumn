...
def extract_measurements_info(python_measurements_folder):
    # Example usage
    folder_path = python_measurements_folder #"C:/dev/git/matchthecolumn/measurement-plugin-python-main/examples"
    signatures = iterate_folder(folder_path)
    return signatures

print(os.getcwd())

folder_ = UI_Window.get_folder_path() 
python_measurements_folder = point_to_python_measurements()
print("--------------------------")


extract_measurements_info(python_measurements_folder)